...
<html lang="en">
    <head>
        ...
        <title>Frognation - {% block title %}{% endblock %}</title>
    ...
    <body role="document">
        ...
        <div class="container">
            ...
            <div class="jumbotron">
                <h1>Welcome to Frognation</h1>
                <p>This is a place where you can manage these cute little frogs.</p>
        ...
        <footer class="footer">
            <div class="container">
                <p class="text-muted">&copy; Frognation 2016 All right reserves.</p>
            </div>
        </footer>
